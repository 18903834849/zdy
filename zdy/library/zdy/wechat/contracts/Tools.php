...
namespace zdy\wechat\contracts;

use zdy\wechat\exceptions\InvalidArgumentException;
use zdy\wechat\exceptions\InvalidResponseException;
use zdy\wechat\exceptions\LocalCacheException;
...
class Tools
{
     ...
     * @var null
     */
    public static $cache_path = WECHAT_CACHE_PATH;
