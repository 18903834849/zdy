...
class PinYin
{
     ...
     * @return string
     */
    public static function zh2py_one($utf8Data, $sRetFormat = 'all')
    {
     ...
     *                        * @return string 拼音
     */
    public static function zh2py($str, $ucfirst = true)
    {
        if (preg_match("/^[a-zA-Z\s]+$/", $str)) {
            return $str;
        }
        $arr = self::mb_str_split($str);
        $re = '';
        foreach ($arr as $v) {
            $str = self::zh2py_one($v);
            $re  .= $ucfirst ? ucfirst($str) : $str;
        }
        return $re;
    }
     ...
     */
    public static function mb_str_split2($str, $split_length = 1, $charset = "UTF-8")
    {
        if (func_num_args() == 1) {
    ...
    public static function mb_str_split($string)
    {
        ...
        while ($strlen) {
            $array[] = mb_substr($string, $start, 1, "utf8");
